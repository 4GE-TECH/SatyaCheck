  ...
  return (
    <div className="sec-card-subtle p-4 space-y-4 font-mono text-xs">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {/* Branch 1: Identity */}
        <div className="p-3 rounded bg-[var(--bg-primary)] border border-[var(--border-default)] space-y-2">
          ...
          <div className="pt-2 border-t border-[var(--border-subtle)] text-[10px] space-y-1 text-[var(--text-secondary)]">
